...
* **Zonas de atendimento**: cada bairro/localidade do OSM vira uma zona ligada ao ponto de distribuição mais próximo (≤ 6 km); edificações OSM a ≤ 2,5 km são atribuídas à zona; população atendida por (município, sistema) rateada por √(edificações).
